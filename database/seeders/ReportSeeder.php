    ...
    public function run()
    {
        ...
        $reports = [
            ...
            [
                ...
                'task_id' => 2, // Task: Pengoperasian Mesin Injection Molding
            ...
            [
                ...
                'production_schedule_id' => 1,
                'task_id' => 3, // Task: QC Bumper Depan
            ...
            [
                ...
                'production_schedule_id' => null,
                'task_id' => 8, // Task: Setup Mesin Produksi Dashboard
                'created_by' => 6, // Rudi (Maintenance)
            ...
            [
                ...
                'production_schedule_id' => null,
                'task_id' => 5, // Task: Pengoperasian Mesin Injection Molding for Bumper Belakang
            ...
            [
                ...
                'production_schedule_id' => null,
                'task_id' => 9, // Task: Produksi Casing Spion
                'created_by' => 3, // Dewi (Manager)
                'report_type' => 'daily',
                'created_at' => $now->copy()->subDays(1),
            ],
            // Contoh laporan dengan jelas siapa yang menyusun dan penanggung jawab berbeda
            [
                'title' => 'Laporan Progres QC Bumper Belakang',
                'content' => "Laporan perkembangan Quality Control untuk bumper belakang Avanza.\n\nHasil pemeriksaan awal:\n- 50 unit telah diperiksa dari total 100 unit\n- 48 unit lolos QC (96%)\n- 2 unit perlu perbaikan minor\n\nKesimpulan: Kualitas produksi batch ini sangat baik. Penyesuaian parameter yang dilakukan sebelumnya memberikan dampak positif.",
                'production_schedule_id' => 2,
                'task_id' => 6, // Task: QC Bumper Belakang (assigned to Nina)
                'created_by' => 8, // Andi (Staff)
                'report_type' => 'quality',
                'created_at' => $now->copy()->subDays(1),
            ],
            [
                'title' => 'Laporan Analisis Material Bumper Depan',
                'content' => "Analisis bahan baku untuk produksi bumper depan batch selanjutnya.\n\nHasil analisis:\n- Material memenuhi standar kualitas\n- Perlu penyesuaian pada temperatur pengolahan\n- Disarankan untuk menambahkan aditif untuk meningkatkan fleksibilitas\n\nRekomendasi: Lakukan trial run dengan parameter baru sebelum produksi massal.",
                'production_schedule_id' => 1,
                'task_id' => 1, // Task: Persiapan Material Bumper Depan (assigned to Eko)
                'created_by' => 2, // Budi (Manager)
                'report_type' => 'quality',
                'created_at' => $now->copy()->subDays(1),
            ],
