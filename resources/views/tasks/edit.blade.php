                ...
                <div class="card-body">
                    <form action="{{ route('tasks.update', $task->id) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('production_schedule_id') is-invalid @enderror" id="production_schedule_id" name="production_schedule_id" required>
                                        ...
                                        @foreach($schedules as $schedule)
                                            <option value="{{ $schedule->id }}" {{ old('production_schedule_id', $task->production_schedule_id) == $schedule->id ? 'selected' : '' }}>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control @error('due_date') is-invalid @enderror" id="due_date" name="due_date" value="{{ old('due_date', $task->due_date->format('Y-m-d\TH:i')) }}" required>
                                    @error('due_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('priority') is-invalid @enderror" id="priority" name="priority" value="{{ old('priority', $task->priority) }}" required min="1" max="5">
                                    @error('priority')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('tasks.show', $task->id) }}" class="btn btn-secondary">Batal</a>
