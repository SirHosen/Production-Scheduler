        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Buat Jadwal Produksi Baru</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('production-schedules.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('production_line') is-invalid @enderror" id="production_line" name="production_line" value="{{ old('production_line') }}" required>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('target_quantity') is-invalid @enderror" id="target_quantity" name="target_quantity" value="{{ old('target_quantity') }}" required min="1">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('production-schedules.index') }}" class="btn btn-secondary">Batal</a>
